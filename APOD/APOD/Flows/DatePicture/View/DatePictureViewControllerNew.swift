...
class DatePictureViewControllerNew: UIViewController {
...
extension DatePictureViewControllerNew: DatePicturePresenterDelegate {
...
extension DatePictureViewControllerNew: DatePictureErrorViewDelegate {
    func didTapRetryButton() {
